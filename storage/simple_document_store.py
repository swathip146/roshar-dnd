...
class SimpleDocumentStore:
    ...
    def __init__(self, collection_name: str = "dnd_documents", top_k: int = DEFAULT_TOP_K, storage_path: str = DEFAULT_STORAGE, ranker_top_k: int= DEFAULT_RANKER_TOP_K):
        """Initialize the document store"""
        self.collection_name = collection_name
        self.model_name = EMBEDDING_MODEL  # For RAGScenarioGenerator compatibility
